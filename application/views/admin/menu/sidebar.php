      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?= ($this->uri->uri_string() == 'admin/peminjaman' || $this->uri->uri_string() == 'admin/pinjam_buku_proses' || $this->uri->uri_string() == 'admin/peminjaman/tambah') ? 'active' : '' ?>"><a class="nav-link" href="<?= ($this->uri->uri_string() == 'admin/peminjaman' || $this->uri->uri_string() == 'admin/pinjam_buku_proses' || $this->uri->uri_string() == 'admin/peminjaman/tambah') ? '#' : base_url('admin/peminjaman') ?>"><i class="fas fa-book-reader"></i> <span>Peminjaman</span></a></li>
