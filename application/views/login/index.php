...
<head>
  ...
  <title>Login &mdash; PERPUSDIG</title>
    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="<?= base_url('stisla/assets/img/logo-login.png') ?>" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
            <h4 class="text-dark font-weight-normal">Selamat Datang di <span class="font-weight-bold">PERPUSDIG</span></h4>
            <p class="text-muted">Silahkan login terlebih dahulu.</p>
            <form method="POST" action="" class="needs-validation" novalidate="">
              <div class="form-group">
                <label for="nis">NIS / NIP</label>
                <input id="nis-nip" type="text" class="form-control" name="nis_nip" autocomplete="off" tabindex="1" required autofocus>
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; SMPN 1 Datuk Limapuluh
            </div>
          </div>
        </div>
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url('stisla/assets/img/unsplash/login-bg.jpg') ?>">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Selamat <?= $salam ?></h1>
